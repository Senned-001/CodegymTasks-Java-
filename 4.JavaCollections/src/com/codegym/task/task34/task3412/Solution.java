...
public class Solution {
    ...
    public void calculateAndSetValue3(long value) {
        logger.trace("calculateAndSetValue3 start");
        value -= 133;
        if (value > Integer.MAX_VALUE) {

            value1 = (int) (value / Integer.MAX_VALUE);
            logger.debug("calculateAndSetValue3 value>Max");
        } else {

            value1 = (int) value;
            logger.debug("calculateAndSetValue3 value");
        }
    }
    ...
    public void printDateAsLong() {
        logger.trace("Printing DateAsLong");
        if (value3 != null) {
